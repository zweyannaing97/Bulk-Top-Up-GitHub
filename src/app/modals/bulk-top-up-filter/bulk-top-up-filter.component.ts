...
@Component({
  selector: 'app-bulk-top-up-filter',
  templateUrl: './bulk-top-up-filter.component.html',
  styleUrls: ['./bulk-top-up-filter.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class BulkTopUpFilterComponent implements OnInit {

  constructor(public dialogRef: MatDialogRef<BulkTopUpFilterComponent>) { }
  maxDate = new Date();
