...
@Component({
  selector: 'app-multiple-top-up-filter',
  templateUrl: './multiple-top-up-filter.component.html',
  styleUrls: ['./multiple-top-up-filter.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class MultipleTopUpFilterComponent implements OnInit {

  constructor(public dialogRef: MatDialogRef<MultipleTopUpFilterComponent>) { }
  maxDate = new Date();
  ...
  fileNames = [
    { viewValue: 'Jan -22- Top Up'},
    { viewValue: 'Jan -22- Data Plan'},
    { viewValue: 'Jan -22- Special Offer'},
  ];
  telecomNames = [
    { viewValue: 'MEC Tel'},
    { viewValue: 'Mpt'},
