...
@Component({
  selector: 'app-single-mobile-detail',
  templateUrl: './single-mobile-detail.component.html',
  styleUrls: ['./single-mobile-detail.component.scss']
})
export class SingleMobileDetailComponent {
