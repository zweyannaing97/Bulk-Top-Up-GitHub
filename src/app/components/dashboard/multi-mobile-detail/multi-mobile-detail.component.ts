...
@Component({
  selector: 'app-multi-mobile-detail',
  templateUrl: './multi-mobile-detail.component.html',
  styleUrls: ['./multi-mobile-detail.component.scss']
})
export class MultiMobileDetailComponent  {
