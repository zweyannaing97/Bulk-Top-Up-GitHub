...
const ELEMENT_DATA: PeriodicElement[] = [
  {numberId:'1',companyName: 'Data Plan',  isActive:'Yes',  action:'assets/icons/Edit.svg'},

  {numberId:'2',companyName: 'FB Pack',  isActive:'No', action:'assets/icons/Edit.svg'},

  {numberId:'3',companyName: 'Special Offer',  isActive:'Yes',  action:'assets/icons/Edit.svg'},

  {numberId:'4',companyName: 'Top Up',  isActive:'Yes',  action:'assets/icons/Edit.svg'},
];
...
const ELEMENT_DATA1: PeriodicElement1[] = [
  ...
  {numberId:'2',companyName: 'Special Offer',  isActive:'Yes',  action:'assets/icons/Edit.svg'},

  {numberId:'3',companyName: 'Top Up',  isActive:'Yes',  action:'assets/icons/Edit.svg'},
];
...
const ELEMENT_DATA2: PeriodicElement2[] = [
  {numberId:'1',companyName: 'FB Pack',  isActive:'No', action:'assets/icons/Edit.svg'},
